...
3. Потом я создал новый текстовый файл _test.txt_, добавил в него некоторый текст и запушил в основуную ветку, используя команды _git add_, _git commit -m_ и _git push_.
...
5. Затем я создал новую ветку _feature_ с помощью команды _git branch_, переключился на нее с помощью _git checkout_.Я отредактировал файл, повторил некоторые шаги из пункта 3, переключился обратно в основную ветку и слил изменения из _feature_ в основную ветку, используя _git merge_ и _git push_.
...
3. Создал ветку для новой функциональности "tesk-management" и создал новый файл task_manager.py:
![image](https://github.com/Andrzakourcev/git-practice/assets/144477949/87015b84-9a5a-4754-906e-44c5e816e708)
4. Закоммитил, завершил фичу и объединил ее с основной веткой:
  ```
